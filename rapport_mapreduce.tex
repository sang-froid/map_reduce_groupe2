...
En distribuant le calcul des distances et la mise à jour des centroides sur un cluster
de machines, cette approche rend possible le traitement de jeux de données qui seraient
tout simplement inaccessibles à un algorithme séquentiel classique. Elle constitue donc
une solution robuste et éprouvée pour le clustering à grande échelle dans les
environnements Big Data modernes.
